...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Basic validation
    if (empty($event['title']) || empty($event['match_date']) || 
                ...
                <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="match_date" name="match_date" class="form-control datetime-input" value="<?php echo $event['match_date']; ?>" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="stage">Stage/Round</label>
                            <input type="text" id="stage" name="stage" class="form-control" value="<?php echo htmlspecialchars($event['stage']); ?>" placeholder="e.g. Quarter Finals, Week 5">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="category" name="category" class="form-control">
                                <option value="Live" <?php echo ($event['category'] == 'Live') ? 'selected' : ''; ?>>Live</option>
                                <option value="Upcoming" <?php echo ($event['category'] == 'Upcoming') ? 'selected' : ''; ?>>Upcoming</option>
                                <option value="Replay" <?php echo ($event['category'] == 'Replay') ? 'selected' : ''; ?>>Replay</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="quality" name="quality" class="form-control">
                                <option value="HD" <?php echo ($event['quality'] == 'HD') ? 'selected' : ''; ?>>HD</option>
                                <option value="4K" <?php echo ($event['quality'] == '4K') ? 'selected' : ''; ?>>4K</option>
                                <option value="SD" <?php echo ($event['quality'] == 'SD') ? 'selected' : ''; ?>>SD</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="stream_url" name="stream_url" class="form-control" value="<?php echo htmlspecialchars($event['stream_url']); ?>" placeholder="URL to stream the event">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload">
                            <input type="file" id="image" name="image" class="image-input" data-preview="imagePreview" accept="image/*">
                            <button type="button" class="btn btn-secondary" onclick="document.getElementById('image').click()">
                                <i class="fas fa-upload"></i> <?php echo (!empty($event['image'])) ? 'Change Image' : 'Upload Image'; ?>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="priceGroup" <?php echo (!$event['is_paid']) ? 'style="display: none;"' : ''; ?>>
                        ...
                        <input type="number" id="price" name="price" class="form-control" value="<?php echo $event['price']; ?>" min="0">
                    </div>
